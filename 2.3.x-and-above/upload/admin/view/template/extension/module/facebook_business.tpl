        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-facebook-business" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-connection">
              ...
              <?php } ?>
              <div class="text-center"><p><small><?php echo $text_plugin_version; ?></small></p></div>
            </div>
...
function updateFacebookBusinessExtensionSettings(data) {
    return new Promise(function(resolve, reject) {
        $.ajax({
            url: "index.php?route=extension/module/facebook_business/updateSettings&token=" + window.facebookAdsToolboxConfig.token_string,
            type: "post",
            data: data,
            dataType: "json",
...
function deleteSettings() {
    return new Promise(function(resolve, reject) {
        $.ajax({
          url: 'index.php?route=extension/module/facebook_business/deleteSettings&token=' + window.facebookAdsToolboxConfig.token_string,
          type: 'post',
          success: function(json) {
            if(!json || !json.success) {
